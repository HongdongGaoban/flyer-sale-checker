...
3. 各フィールドの解釈は以下の通り：
  ...
  - category: 商品の大分類。
              【重要】以下の条件をすべて満たす場合のみ、指定の品目名を使用すること：
                ...
                ③ 以下のリストに含まれる品目であること：
              キャベツ / レタス / にんじん / たまねぎ / ほうれん草 / トマト / きゅうり / なす / ピーマン / ねぎ / もやし / じゃがいも / 大根 / はくさい / ブロッコリー / さつまいも / かぼちゃ / 生しいたけ / えのきたけ / しめじ / 牛肉 / 豚肉 / 豚肉こま切れ / 鶏肉 / 卵 / 牛乳 / 豆腐 / バナナ / りんご / みかん
              上記に該当しない場合（味付け肉・加工肉・輸入表記があるだけで未加工の場合を除く・魚介類・加工食品等）は品目名を記載（例: "味付け牛カルビ"、"ねぎ塩豚タン"、"鮭"、"飲料"、"カップ麺"）
              ※「旨だれ」「ねぎ塩」「タレ」「塩こしょう」「味付け」「漬け」等の語が商品名に含まれる肉類は、生鮮品目名ではなく具体的な品目名を記載すること
              ※豆腐は「木綿豆腐」「絹豆腐」等すべて「豆腐」とすること。「卵豆腐」「ごま豆腐」等は豆腐に含めないこと
              ※バナナは生の未加工品のみ対象。乾燥バナナ・バナナチップス等は「バナナ加工品」として記載すること
              ※きのこ類（生しいたけ・えのきたけ・しめじ）は生の未加工品のみ。味付け・乾燥品は除く
  ...
  - is_multi_buy: まとめ買い条件がある場合は true（例: "2個で○○円"、"3点以上で○○円"）
  - is_conditional: その価格を得るために特別な資格・手続きが必要な場合のみ true
                    true にすべきケース: 会員カード・ポイントカード提示価格、アプリクーポン使用価格、特定カード支払い限定価格
                    false にすべきケース: チラシ掲載の通常特売価格、タイムセール（誰でも買える時間限定セール）、
                                         お一人様〇点まで等の購入数制限（価格条件ではなく数量上限）、
                                         本日限り・〇月〇日まで等の期間限定（→ target_date に記載）
